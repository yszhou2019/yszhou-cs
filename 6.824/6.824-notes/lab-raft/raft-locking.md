...
Whenever you have data that more than one goroutine uses, and at least one goroutine might modify the data, the goroutines should
...
临界区代码因为持有锁，可能导致低效率，比如死锁现象。
可以考虑单独创建goroutine来进行等待锁资源释放。
